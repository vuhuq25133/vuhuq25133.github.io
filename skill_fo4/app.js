...
const SKILLS_DATA = [
  ...
  {
    id: "gia-vo-lon-trickster",
    name: "Giả vờ lớn (Chỉ dành cho Trickster)",
    category: "2★",
    keyboard: "Giữ CAPS + → → , ← ← hoặc Giữ C + SHIFT + → → , ← ←",
    controller: "Giữ LT + RS → → hoặc ← ←"
  },
  // --- 3 STARS ---
  {
  ...
  {
    id: "dao-bong-toc-do-trickster",
    name: "Đảo bóng tốc độ (Chỉ dành cho Trickster)",
    category: "3★",
    keyboard: "Giữ X + ↑ ↗ → , ↑ ↖ ← hoặc Giữ Q + SHIFT + ↑ ↗ → , ↑ ↖ ←",
    controller: "Giữ LB + RS ↑ ↗ → hoặc ↑ ↖ ←"
  },
  // --- 4 STARS ---
  {
  ...
  },
  {
    ...
    name: "Kéo bóng",
    category: "4★",
    keyboard: "SHIFT + Giữ ← rồi nhấn → / Giữ → nhấn tiếp tục ←",
  ...
  },
  {
    ...
    category: "4★",
    keyboard: "C + ← / → + A hoặc D Sau đó nhấn S",
    controller: "LT ← / → + X hoặc B sau đó nhấn A"
  },
  {
    id: "rainbow-4",
    name: "Rainbow",
  ...
  },
  {
    ...
    category: "4★",
    keyboard: "SHIFT + giữ ← hoặc → sau đó bấm ↑",
    controller: "RS Giữ ← hoặc → kế LS nẩy ↑"
  },
  {
    id: "v-drag-movement-stop",
    name: "V drag movement (stop state)",
    category: "4★",
    keyboard: "Giữ E + A hoặc D sau đó ấn SHIFT + S + ↑ → hay ↑ ←",
    controller: "Giữ RT + X hoặc B sau đó A + LS ↗ → hoặc ↑ ←"
  },
  {
    id: "heel-chop-turn",
    name: "Heel Chop Turn",
  ...
  },
  {
    ...
    name: "Drag to Heel",
    category: "4★",
    keyboard: "Giữ X + ↑ ← → (Gẩy) hoặc Giữ Q + SHIFT + ↑ ← → (Gẩy)",
    controller: "Giữ LB + RS ↑ ← →"
  },
  {
    id: "four-touch-skill",
  ...
  {
    id: "dao-chan-giu-bong-trickster",
    name: "Đảo chân giữ bóng (Chỉ dành cho Trickster)",
    category: "4★",
    keyboard: "Giữ Z + SHIFT + → → hoặc ← ←",
    controller: "Giữ RB + RS → → hoặc ← ←"
  },
  // --- 5 STARS ---
  {
    id: "juggle-backward-change",
    name: "Juggle backward change (juggling)",
    category: "5★",
    keyboard: "C + giữ ↓",
    controller: "Giữ LS ↓"
  },
  {
    id: "doi-huong-tang-bong",
    name: "Đổi hướng khi đang tâng bóng",
    category: "5★",
    keyboard: "C + giữ ← / →",
    controller: "Giữ LS ← / →"
  },
  ...
  },
  {
    ...
    category: "5★",
    keyboard: "SHIFT + ClockwiseArrow (theo chiều kim hoặc ngược chiều kim đồng hồ)",
    controller: "Xoay RS theo chiều kim đồng hồ hoặc ngược chiều kim đồng hồ"
  },
  {
    id: "in-air-elastico",
  ...
  {
    id: "elastico-caps-c",
    name: "Elastico (Giữ CAPS / C)",
    category: "5★",
    keyboard: "Giữ CAPS + Z + ↓ ← / ↓ → hoặc Giữ C + Z + SHIFT + ↓ ← / ↓ →",
    controller: "Giữ LT + RB + RS ↓ ← / ↓ →"
  },
  {
    id: "okocha-sombrero",
  ...
  },
  {
    ...
    name: "Bolasie Flick",
    category: "5★",
    keyboard: "SHIFT + Giữ Z + Đẩy ↑ , ← hoặc →",
    controller: "Giữ RB + RS Nẩy ↑ , ← hoặc →"
  },
  {
    id: "turn-spin",
    name: "Turn spin",
  ...
  {
    id: "labona-trick-sprinting",
    name: "LABONA trick action (sprinting state)",
    category: "5★",
    keyboard: "C + D hoặc A sau khi bấm S + ↓",
    controller: "Giữ LT + X hoặc B rồi A + LS ↓"
  },
  {
    id: "day",
    name: "Đẩy",
    category: "5★",
    keyboard: "A hoặc D Sau khi nhấn S + Từ trái sang trước / từ trước sang phải",
    controller: "X hoặc B sau khi nhấn A + từ trái sang phải / từ trước sang phải"
  },
  {
    id: "scoop-turn-fake",
  ...
  },
  {
    ...
    name: "Flair Nutmeg",
    category: "5★",
    keyboard: "Giữ C + Z + ArrowKeys",
    controller: "Giữ LT + RB + LS(direction)"
  },
  {
  ...
  {
    id: "keo-bong-mui-chan-dao-nguoi-trickster",
    name: "Kéo bóng bằng mũi chân rồi đảo người (Chỉ dành cho Trickster)",
    category: "5★",
    keyboard: "Giữ X + → → , ← ← hoặc Giữ Q + SHIFT + → → , ← ←",
    controller: "Giữ LB + RS → → hoặc ← ←"
  },
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Enable mouse wheel horizontal scrolling on scrollable combinations
  document.addEventListener("wheel", (e) => {
    const scrollContainer = e.target.closest('.instruction-display, .split-row');
    if (scrollContainer) {
